...
# read csv file
with open("full_description/kimono.csv", newline='', encoding='cp932')  as csvfile:
    reader = csv.DictReader(csvfile)
    row = next(reader)  

# create URI
subject = NS["tea"]["item_kimono"]
...
g.add((subject, NS["crm"]["P50_has_current_keeper"], NS["wd"]["Q49133"]))
g.add((subject, NS["dcterms"]["source"], URIRef("https://collections.mfa.org/objects/28742/kimono-hitoe")))
g.add((subject, NS["crm"]["P2_has_type"], NS["wd"]["Q483444"]))


# output
write_graph(g, "kimono.ttl")
