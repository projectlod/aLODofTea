...
# read csv file
with open("full_description/teascoop.csv", newline='', encoding='cp932')  as csvfile:
    reader = csv.DictReader(csvfile)
    row = next(reader)  

# create URI
subject = NS["tea"]["item_teascoop"]
...
g.add((subject, NS["crm"]["P94i_was_created_by"], NS["tea"]["person_sen-no-rikyu"]))
...
g.add((subject, NS["dcterms"]["source"], URIRef("https://www.metmuseum.org/art/collection/search/752041")))
g.add((subject, NS["crm"]["P2_has_type"], NS["wd"]["Q3006804"]))


# output
write_graph(g, "teascoop.ttl")
